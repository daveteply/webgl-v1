import { Dn as n, Tn as l, on as se$1, z as M } from './main-4N6IXW4D.js';
var _ = (function (n) {
  return (
    (n[(n.State = 0)] = `State`),
...
function Ie(n, e, t) {
  let s = t.totalTime,
    i = !!t.disabled,
    r = ge(n.element, n.triggerName, n.fromState, n.toState, e || n.phaseName, s ?? n.totalTime, i),
    a = n._data;
  return (a != null && (r._data = a), r);
}
function ge(n, e, t, s, i = ``, r = 0, a) {
  return { element: n, triggerName: e, fromState: t, toState: s, phaseName: i, totalTime: r, disabled: !!a };
}
function F(n, e, t) {
  let s = n.get(e);
...
var wt = !1;
function Jt(n) {
  X || ((X = Os() || {}), (wt = X.style ? `WebkitAppearance` in X.style : !1));
  let e = !0;
  return (
    X.style &&
      !ks(n) &&
      ((e = n in X.style), !e && wt && (e = `Webkit` + n.charAt(0).toUpperCase() + n.slice(1) in X.style)),
    e
  );
}
function Fs(n) {
...
function ue(n, e, t) {
  return typeof n == `object` && n !== null && Object.hasOwn(n, `duration`) ? n : zs(n, e, t);
}
...
function zs(n, e, t) {
  ...
  if (typeof n == `string`) {
    let a = n.match(Is);
    if (a === null) return (e.push(bt(n)), { duration: 0, delay: 0, easing: `` });
  ...
  if (!t) {
    let a = !1,
      o = e.length;
    (s < 0 && (e.push(bs()), (a = !0)), i < 0 && (e.push(ws()), (a = !0)), a && e.splice(o, 0, bt(n)));
  }
...
function te(n) {
  return Array.isArray(n) ? (n.length == 1 ? n[0] : vt(n)) : n;
}
function es(n, e, t) {
  let s = e.params || {},
    i = Ge(n);
...
function se(n, e, t) {
  let s = `${n}`,
    i = s.replace(Ke, (r, a) => {
      let o = e[a];
      return (o ?? (t.push(Ps(a)), (o = ``)), o.toString());
    });
  return i == s ? n : i;
}
var Ks = /-+([a-z0-9])/g;
...
function Qs(n, e) {
  let t = [];
  return (typeof n == `string` ? n.split(/\s*,\s*/).forEach((s) => Vs(s, t, e)) : t.push(n), t);
}
function Vs(n, e, t) {
  if (n[0] == `:`) {
    let l = $s(n, t);
  ...
  if (s == null || s.length < 4) return (t.push(zt(n)), e);
  let i = s[1],
    r = s[2],
    a = s[3];
  e.push(ns(i, a));
...
var ve = new Set([`true`, `1`]);
var be = new Set([`false`, `0`]);
function ns(n, e) {
  let t = ve.has(n) || be.has(n),
    s = ve.has(e) || be.has(e);
  return (i, r) => {
    let a = n == Pe || n == i,
      o = e == Pe || e == r;
    return (
      !a && t && typeof i == `boolean` && (a = i ? ve.has(n) : be.has(n)),
      !o && s && typeof r == `boolean` && (o = r ? ve.has(e) : be.has(e)),
      a && o
    );
  };
}
var ys = `:self`;
var Us = new RegExp(`s*${ys}s*,?`, `g`);
function dt(n, e, t, s) {
  return new tt(n).build(e, t, s);
}
var rs = ``;
var tt = class {
  _driver;
  ...
  build(e, t, s) {
    let i = new st(t);
    return (this._resetContextStyleTimingState(i), O(this, te(e), i));
  }
  _resetContextStyleTimingState(e) {
    ((e.currentQuerySelector = rs),
      (e.collectedStyles = new Map()),
      e.collectedStyles.set(rs, new Map()),
      (e.currentTime = 0));
  }
  visitTrigger(e, t) {
    let s = (t.queryCount = 0),
      ...
      a = [];
    return (
      e.name.charAt(0) == `@` && t.errors.push(Pt()),
      e.definitions.forEach((o) => {
        if ((this._resetContextStyleTimingState(t), o.type == _.State)) {
          let l = o,
            u = l.name;
          (u
            .toString()
        ...
        } else t.errors.push(Nt());
      }),
      { type: _.Trigger, name: e.name, states: r, transitions: a, queryCount: s, depCount: i, options: null }
    );
  }
  visitState(e, t) {
    ...
    if (s.containsDynamicStyles) {
      ...
      (s.styles.forEach((o) => {
        o instanceof Map &&
          o.forEach((l) => {
            Ge(l).forEach((u) => {
              Object.hasOwn(a, u) || r.add(u);
            });
          });
      }),
        r.size && t.errors.push(Ct(e.name, [...r.values()])));
    }
    return { type: _.State, name: e.name, style: s, options: i ? { params: i } : null };
  }
  visitTransition(e, t) {
    ((t.queryCount = 0), (t.depCount = 0));
    let s = O(this, te(e.animation), t),
  ...
  visitSequence(e, t) {
    return { type: _.Sequence, steps: e.steps.map((s) => O(this, s, t)), options: x(e.options) };
  }
  visitGroup(e, t) {
    let s = t.currentTime,
      i = 0,
  ...
  _makeStyleAst(e, t) {
    ...
    for (let o of i)
      typeof o == `string` ? (o === z ? s.push(o) : t.errors.push(Dt(o))) : s.push(new Map(Object.entries(o)));
    let r = !1,
      a = null;
    return (
      s.forEach((o) => {
          ...
          a.forEach((o, l) => {
            ...
            (c &&
              (r != i &&
                r >= c.startTime &&
                i <= c.endTime &&
                (t.errors.push(Mt(l, c.startTime, c.endTime, r, i)), (h = !1)),
              (r = c.startTime)),
              h && u.set(l, { startTime: r, endTime: i }),
              t.options && es(o, t.options, t.errors));
          });
      }));
  }
  visitKeyframes(e, t) {
    let s = { type: _.Keyframes, styles: [], options: null };
    if (!t.currentAnimateTimings) return (t.errors.push(kt()), s);
    let i = 1,
      r = 0,
      a = [],
      o = !1,
      ...
      c = e.steps.map((w) => {
        let A = this._makeStyleAst(w, t),
          D = A.offset != null ? A.offset : Ws(A.styles),
          N = 0;
        return (
          D != null && (r++, (N = A.offset = D)),
          (l = l || N < 0 || N > 1),
          (o = o || N < u),
          (u = N),
          a.push(N),
    ...
    (l && t.errors.push(Ft()), o && t.errors.push(Ot()));
    let h = e.steps.length,
      S = 0;
    r > 0 && r < h ? t.errors.push(Rt()) : r == 0 && (S = i / (h - 1));
    let y = h - 1,
      d = t.currentTime,
  ...
  visitReference(e, t) {
    return { type: _.Reference, animation: O(this, te(e.animation), t), options: x(e.options) };
  }
  visitAnimateChild(e, t) {
    return (t.depCount++, { type: _.AnimateChild, options: x(e.options) });
  }
  visitAnimateRef(e, t) {
    return { type: _.AnimateRef, animation: this.visitReference(e.animation, t), options: x(e.options) };
  }
  visitQuery(e, t) {
    ...
    ((t.currentQuerySelector = s.length ? s + ` ` + r : r), F(t.collectedStyles, t.currentQuerySelector, new Map()));
    let o = O(this, te(e.animation), t);
    return (
      (t.currentQuery = null),
  ...
  visitStagger(e, t) {
    t.currentQuery || t.errors.push(Lt());
    let s = e.timings === `full` ? { duration: 0, delay: 0, easing: `full` } : ue(e.timings, t.errors, !0);
    return { type: _.Stagger, animation: O(this, te(e.animation), t), timings: s, options: null };
  }
};
function js(n) {
  let e = !!n.split(/\s*,\s*/).find((t) => t == ys);
  return (
    e && (n = n.replace(Us, ``)),
    (n = n
      .replace(/@\*/g, le)
      .replace(/@\w+/g, (t) => le + `-` + t.slice(1))
      .replace(/:animating/g, Se)),
    [n, e]
  );
}
function Gs(n) {
...
function Hs(n, e) {
  if (typeof n == `object` && n !== null && Object.hasOwn(n, `duration`)) return n;
  if (typeof n == `number`) {
...
function x(n) {
  return (n ? ((n = l({}, n)), n.params && (n.params = Gs(n.params))) : (n = {}), n);
}
function We(n, e, t) {
  return { duration: n, delay: e, easing: t };
}
function mt(n, e, t, s, i, r, a = null, o = !1) {
  return {
    type: 1,
    element: n,
    keyframes: e,
...
var Ys = 1;
var xs = new RegExp(`:enter`, `g`);
var Zs = new RegExp(`:leave`, `g`);
function pt(n, e, t, s, i, r = new Map(), a = new Map(), o, l, u = []) {
  return new it().buildKeyframes(n, e, t, s, i, r, a, o, l, u);
}
var it = class {
  buildKeyframes(e, t, s, i, r, a, o, l, u, c = []) {
    u = u || new ne();
    let h = new nt(e, t, u, i, r, c, []);
    h.options = l;
    let S = l.delay ? V(l.delay) : 0;
    (h.currentTimeline.delayNextStep(S), h.currentTimeline.setStyles([a], null, h.errors, l), O(this, s, h));
    let y = h.timelines.filter((d) => d.containsAnimation());
    if (y.length && o.size) {
      let d;
  ...
  _visitSubInstructions(e, t, s) {
    let r = t.currentTimeline.currentTime,
      a = s.duration != null ? V(s.duration) : null,
      o = s.delay != null ? V(s.delay) : null;
    return (
      a !== 0 &&
        e.forEach((l) => {
  ...
  visitReference(e, t) {
    (t.updateOptions(e.options, !0), O(this, e.animation, t), (t.previousNode = e));
  }
  visitSequence(e, t) {
  ...
  _visitTiming(e, t) {
    if (e.dynamic) {
      let s = e.strValue;
      return ue(t.params ? se(s, t.params, t.errors) : s, t.errors);
  ...
  visitKeyframes(e, t) {
    ...
    ((o.easing = s.easing),
      e.styles.forEach((l) => {
        let u = l.offset || 0;
        (o.forwardTime(u * r), o.setStyles(l.styles, l.easing, t.errors, t.options), o.applyStylesToKeyframe());
      }),
  ...
  visitQuery(e, t) {
    ...
    r &&
      (t.previousNode.type === _.Style || (s == 0 && t.currentTimeline.hasCurrentStyleProperties())) &&
      (t.currentTimeline.snapshotCurrentStyles(), (t.previousNode = Ne));
    let a = s,
    ...
    (o.forEach((u, c) => {
      ...
      let h = t.createSubContext(e.options, u);
      (r && h.delayNextStep(r),
        u === t.element && (l = h.currentTimeline),
        O(this, e.animation, h),
  ...
  visitStagger(e, t) {
    ...
    (O(this, e.animation, t),
      (t.previousNode = e),
      (s.currentStaggerTime = i.currentTime - h + (i.startTime - s.currentTimeline.startTime)));
  }
};
var Ne = {};
var nt = class n {
  ...
  constructor(e, t, s, i, r, a, o, l) {
    ((this._driver = e),
      ...
      (this.errors = a),
      (this.timelines = o),
      (this.currentTimeline = l || new Ce(this._driver, t, 0)),
    ...
    if (r) {
      ...
      (a || (a = this.options.params = {}),
        Object.keys(r).forEach((o) => {
          (!t || !Object.hasOwn(a, o)) && (a[o] = se(r[o], a, this.errors));
        }));
    }
  }
  _copyOptions() {
  ...
  appendInstructionToTimeline(e, t, s) {
    let i = { duration: t ?? e.duration, delay: this.currentTimeline.currentTime + (s ?? 0) + e.delay, easing: `` },
      r = new rt(this._driver, e.element, e.keyframes, e.preStyleProps, e.postStyleProps, i, e.stretchStartingKeyframe);
  ...
  invokeQuery(e, t, s, i, r, a) {
    ...
    return (!r && o.length == 0 && a.push(It(t)), o);
  }
};
var Ce = class n {
  _driver;
  ...
  applyEmptyStep(e) {
    ...
    for (let [t, s] of this._globalTimelineStyles) (this._backFill.set(t, s || z), this._currentKeyframe.set(t, z));
  ...
  setStyles(e, t, s, i) {
    ...
    for (let [o, l] of a) {
      ...
      (this._pendingStyles.set(o, u),
        this._localTimelineStyles.has(o) || this._backFill.set(o, this._globalTimelineStyles.get(o) ?? z),
...
var rt = class extends Ce {
  ...
  constructor(e, t, s, i, r, a, o = !1) {
    (super(e, t, a.delay),
      ...
      (this.timings = { duration: a.duration, delay: a.delay, easing: a.easing }));
  }
  containsAnimation() {
  ...
  buildKeyframes() {
    ...
    if (this._stretchStartingKeyframe && t) {
      ...
      let u = new Map(e[0]);
      (u.set(`offset`, as(o)), r.push(u));
      let c = e.length - 1;
      for (let h = 1; h <= c; h++) {
        let S = new Map(e[h]),
          y = S.get(`offset`),
          d = t + y * s;
        (S.set(`offset`, as(d / a)), r.push(S));
      }
      ((s = a), (t = 0), (i = ``), (e = r));
    }
...
function os(n, e, t, s, i, r, a, o, l, u, c, h, S) {
  return {
    type: 0,
    element: n,
    triggerName: e,
...
var De = class {
  ...
  buildStyles(e, t, s) {
    ...
    return (e !== void 0 && (i = this._stateStyles.get(e?.toString()) || i), i ? i.buildStyles(t, s) : new Map());
  }
  build(e, t, s, i, r, a, o, l, u, c) {
    let h = [],
      S = (this.ast.options && this.ast.options.params) || He,
      y = (o && o.params) || He,
      d = this.buildStyles(s, y, h),
      g = (l && l.params) || He,
      v = this.buildStyles(i, g, h),
      w = new Set(),
      A = new Map(),
      D = new Map(),
      N = i === `void`,
      J = { params: _s(g, S), delay: this.ast.options?.delay },
      B = c ? [] : pt(e, t, this.ast.animation, r, a, d, v, J, u, h),
      M = 0;
    return (
      B.forEach((k) => {
        M = Math.max(k.duration + k.delay, M);
      }),
      h.length
        ? os(t, this._triggerName, s, i, N, d, v, [], [], A, D, M, h)
        : (B.forEach((k) => {
            let W = k.element,
              Z = F(A, W, new Set());
            k.preStyleProps.forEach((H) => Z.add(H));
            let gt = F(D, W, new Set());
            (k.postStyleProps.forEach((H) => gt.add(H)), W !== t && w.add(W));
          }),
          os(t, this._triggerName, s, i, N, d, v, B, [...w.values()], A, D, M))
    );
  }
};
  ...
  constructor(e, t, s) {
    ((this.name = e),
      ...
      t.states.forEach((i) => {
        ...
        this.states.set(i.name, new at(i.style, r, s));
      }),
      ls(this.states, `true`, `1`),
      ls(this.states, `false`, `0`),
      t.transitions.forEach((i) => {
        this.transitionFactories.push(new De(e, i, this.states));
      }),
      (this.fallbackTransition = ii(e, this.states)));
  }
  get containsQueries() {
...
function ii(n, e, t) {
  ...
  return new De(n, { type: _.Transition, animation: i, matchers: s, options: null, queryCount: 0, depCount: 0 }, e);
}
function ls(n, e, t) {
...
var lt = class {
  ...
  register(e, t) {
    let s = [],
      r = dt(this._driver, t, s, []);
    if (s.length) throw Vt(s);
    this._animations.set(e, r);
  }
  _buildPlayer(e, t, s) {
    let i = e.element,
      r = qe(this._normalizer, e.keyframes, t, s);
  ...
  create(e, t, s = {}) {
    ...
    if (
      (r
        ? ((a = pt(this._driver, t, r, `ng-enter`, `ng-leave`, new Map(), new Map(), s, ni, i)),
          a.forEach((c) => {
            let h = F(o, c.element, new Map());
            c.postStyleProps.forEach((S) => h.set(S, null));
          }))
        : (i.push($t()), (a = [])),
      i.length)
    )
    ...
    o.forEach((c, h) => {
      c.forEach((S, y) => {
        c.set(y, this._driver.computeStyle(h, y, z));
      });
    });
    let u = U(
      a.map((c) => {
        let h = o.get(c.element);
        return this._buildPlayer(c, new Map(), h);
      }),
    );
  ...
  listen(e, t, s, i) {
    let r = ge(t, ``, ``, ``);
    return (pe(this._getPlayer(e), s, r, i), () => {});
  }
  command(e, t, s, i) {
    if (s == `register`) {
      this.register(e, i[0]);
...
var us = `ng-animate-queued`;
var ri = `.ng-animate-queued`;
var Ye = `ng-animate-disabled`;
var ai = `.ng-animate-disabled`;
var oi = `ng-star-inserted`;
var li = `.ng-star-inserted`;
var ui = [];
var Ss = { namespaceId: ``, setForRemoval: !1, setForMove: !1, hasAnimation: !1, removedBeforeQueried: !1 };
var hi = { namespaceId: ``, setForMove: !1, setForRemoval: !1, hasAnimation: !1, removedBeforeQueried: !0 };
var q = `__ng_removed`;
var ce = class {
  namespaceId;
  value;
...
var ut = class {
  ...
  listen(e, t, s, i) {
    if (!this._triggers.has(t)) throw Gt(s, t);
    if (s == null || s.length == 0) throw Wt(t);
    if (!di(s)) throw Ht(s, t);
    let r = F(this._elementListeners, e, []),
      a = { name: t, phase: s, callback: i };
    r.push(a);
    let o = F(this._engine.statesByElement, e, new Map());
    return (
      o.has(t) || (I(e, oe), I(e, oe + `-` + t), o.set(t, Xe)),
      () => {
  ...
  trigger(e, t, s, i = !0) {
    let r = this._getTrigger(t),
      a = new fe(this.id, t, e),
      o = this._engine.statesByElement.get(e);
    o || (I(e, oe), I(e, oe + `-` + t), this._engine.statesByElement.set(e, (o = new Map())));
    let l = o.get(t),
      u = new ce(s, this.id);
    if (
      (!(s && Object.hasOwn(s, `value`)) && l && u.absorbOptions(l.options),
      o.set(t, u),
      l || (l = Xe),
  ...
  _signalRemovalForInnerTriggers(e, t) {
    let s = this._engine.driver.query(e, le, !0);
    (s.forEach((i) => {
      if (i[q]) return;
  ...
  removeNode(e, t) {
    ...
    if ((this.prepareLeaveAnimationListeners(e), i)) s.markElementAsRemoved(this.id, e, !1, t);
      ...
      let r = e[q];
      (!r || r === Ss) &&
        (s.afterFlush(() => this.clearElementCache(e)), s.destroyInnerAnimations(e), s._onRemovalComplete(e, t));
    }
  }
  insertNode(e, t) {
...
var ht = class {
  ...
  markElementAsDisabled(e, t) {
    t
      ? this.disabledNodes.has(e) || (this.disabledNodes.add(e), I(e, Ye))
      : this.disabledNodes.has(e) && (this.disabledNodes.delete(e), ie(e, Ye));
  }
  removeNode(e, t, s) {
    if (we(t)) {
  ...
  listen(e, t, s, i, r) {
    return we(t) ? this._fetchNamespace(e).listen(t, s, i, r) : () => {};
  }
  ...
  destroyInnerAnimations(e) {
    let t = this.driver.query(e, le, !0);
    (t.forEach((s) => this.destroyActiveAnimationsForElement(s)),
      this.playersByQueriedElement.size != 0 &&
        ((t = this.driver.query(e, Se, !0)), t.forEach((s) => this.finishActiveQueriedAnimationOnElement(s))));
  }
  ...
  processLeaveNode(e) {
    ...
    (e.classList?.contains(Ye) && this.markElementAsDisabled(e, !1),
  ...
  flush(e = -1) {
    ...
    if (
      (this.newHostElements.size &&
        (this.newHostElements.forEach((s, i) => this._balanceNamespaceList(s, i)), this.newHostElements.clear()),
  ...
  _flushAnimations(e, t) {
    ...
    let h = this.bodyNode,
      ...
      y = fs(S, this.collectedEnterElements),
      d = new Map(),
      g = 0;
    y.forEach((f, m) => {
      let p = _e + g++;
    ...
    for (let f = 0; f < this.collectedLeaveElements.length; f++) {
      ...
      p &&
        p.setForRemoval &&
        (v.push(m), w.add(m), p.hasAnimation ? this.driver.query(m, li, !0).forEach((T) => w.add(T)) : A.add(m));
    }
    let D = new Map(),
      N = fs(S, Array.from(w));
    (N.forEach((f, m) => {
    ...
    for (let f = this._namespaceList.length - 1; f >= 0; f--)
      this._namespaceList[f].drainQueuedTransitions(t).forEach((p) => {
        let T = p.player,
          P = p.element;
        if ((J.push(T), this.collectedEnterElements.length)) {
          let C = P[q];
          if (C && C.setForMove) {
            if (C.previousTriggersValues && C.previousTriggersValues.has(p.triggerName)) {
              let Y = C.previousTriggersValues.get(p.triggerName),
        ...
        let Q = !h || !this.driver.containsElement(h, P),
          R = D.get(P),
          j = d.get(P),
          b = this._buildInstruction(p, s, j, R, Q);
        ...
        let St = [];
        (b.timelines.forEach((C) => {
          ((C.stretchStartingKeyframe = !0), this.disabledNodes.has(C.element) || St.push(C));
        }),
          (b.timelines = St),
          s.append(P, b.timelines));
        let vs = { instruction: b, player: T, element: P };
        (a.push(vs),
          b.queriedElements.forEach((C) => F(o, C, []).push(T)),
          b.preStyleProps.forEach((C, Y) => {
            if (C.size) {
              let L = l.get(Y);
              (L || l.set(Y, (L = new Set())), C.forEach((de, Re) => L.add(Re)));
            }
          }),
          b.postStyleProps.forEach((C, Y) => {
            let L = u.get(Y);
            (L || u.set(Y, (L = new Set())), C.forEach((de, Re) => L.add(Re)));
          }));
      });
    if (B.length) {
      let f = [];
      (B.forEach((m) => {
        f.push(xt(m.triggerName, m.errors));
      }),
    ...
    (a.forEach((f) => {
      let m = f.element;
      s.has(m) && (k.set(m, m), this._beforeAnimationBuild(f.player.namespaceId, f.instruction, M));
    }),
      i.forEach((f) => {
        let m = f.element;
        this._getPreviousPlayers(m, !1, f.namespaceId, f.triggerName, null).forEach((T) => {
          (F(M, m, []).push(T), T.destroy());
        });
      }));
    let W = v.filter((f) => ds(f, l, u)),
      Z = new Map();
    cs(Z, this.driver, A, u, z).forEach((f) => {
      ds(f, l, u) && W.push(f);
    });
    let H = new Map();
    (y.forEach((f, m) => {
      cs(H, this.driver, new Set(f), l, re);
    }),
      W.forEach((f) => {
        let m = Z.get(f),
          p = H.get(f);
        Z.set(f, new Map([...(m?.entries() ?? []), ...(p?.entries() ?? [])]));
      }));
    let Oe = [],
      yt = [],
      _t = {};
    (a.forEach((f) => {
      ...
      if (s.has(m)) {
        ...
        if ((p.setRealPlayer(Q), P === _t)) Oe.push(p);
        else {
          let R = this.playersByElement.get(P);
          (R && R.length && (p.parentPlayer = U(R)), i.push(p));
        }
      } else (G(m, T.fromStyles), p.onDestroy(() => K(m, T.toStyles)), yt.push(p), c.has(m) && i.push(p));
    }),
      yt.forEach((f) => {
    ...
    for (let f = 0; f < v.length; f++) {
      let m = v[f],
        p = m[q];
      if ((ie(m, `ng-leave`), p && p.hasAnimation)) continue;
      let T = [];
      if (o.size) {
        let Q = o.get(m);
        Q && Q.length && T.push(...Q);
        let R = this.driver.query(m, Se, !0);
  ...
  _getPreviousPlayers(e, t, s, i, r) {
    ...
    if (t) {
      ...
      if (o) {
        let l = !r || r == he;
        o.forEach((u) => {
          u.queued || (!l && u.triggerName != i) || a.push(u);
        });
      }
    }
  ...
  _beforeAnimationBuild(e, t, s) {
    ...
    for (let l of t.timelines) {
      let u = l.element,
        c = u !== r,
        h = F(s, u, []);
      this._getPreviousPlayers(u, c, a, o, t.toState).forEach((y) => {
        let d = y.getRealPlayer();
        (d.beforeDestroy && d.beforeDestroy(), y.destroy(), h.push(y));
      });
    }
    G(r, t.fromStyles);
  }
  _buildAnimation(e, t, s, i, r, a) {
    let o = t.triggerName,
      ...
      S = t.timelines.map((d) => {
        ...
        c.add(g);
        let v = g[q];
        if (v && v.removedBeforeQueried) return new $(d.duration, d.delay);
        let w = g !== l,
          A = pi((s.get(g) || ui).map((M) => M.getRealPlayer())).filter((M) => {
            let k = M;
            return k.element ? k.element === g : !1;
          }),
          D = r.get(g),
          N = a.get(g),
          J = qe(this._normalizer, d.keyframes, D, N),
          B = this._buildPlayer(d, J, A);
        if ((d.subTimeline && i && h.add(g), w)) {
          let M = new fe(e, o, g);
    ...
    return (
      y.onDestroy(() => {
        (c.forEach((d) => ie(d, Ue)), K(l, t.toStyles));
      }),
      h.forEach((d) => {
        F(i, d, []).push(y);
      }),
...
function cs(n, e, t, s, i) {
  let r = [];
  t.forEach((l) => r.push(hs(l)));
  let a = [];
  s.forEach((l, u) => {
    let c = new Map();
    (l.forEach((h) => {
      let S = e.computeStyle(u, h, i);
      (c.set(h, S), (!S || S.length == 0) && ((u[q] = hi), a.push(u)));
    }),
      n.set(u, c));
  });
  let o = 0;
  return (t.forEach((l) => hs(l, r[o++])), a);
}
function fs(n, e) {
  let t = new Map();
...
function gi(n, e) {
  ...
  for (let i = 0; i < t.length; i++) {
    let r = t[i];
    if (!Object.hasOwn(e, r) || n[r] !== e[r]) return !1;
  }
  return !0;
}
function ds(n, e, t) {
...
var Me = class {
  ...
  constructor(e, t, s) {
    ((this._driver = t),
      (this._normalizer = s),
      (this._transitionEngine = new ht(e.body, t, s)),
      (this._timelineEngine = new lt(e.body, t, s)),
  ...
  registerTrigger(e, t, s, i, r) {
    ...
    if (!o) {
      let l = [],
        c = dt(this._driver, r, l, []);
      if (l.length) throw Qt(i, l);
...
function yi(n, e) {
  ...
  return (
    Array.isArray(e) && e.length
      ? ((t = xe(e[0])), e.length > 1 && (s = xe(e[e.length - 1])))
      : e instanceof Map && (t = xe(e)),
    t || s ? new _i(n, t, s) : null
  );
}
var _i = (() => {
  class n {
...
var ke = class {
  ...
  _buildPlayer() {
    ...
    this._initialized = !0;
    let e = this.keyframes,
      t = this._triggerWebAnimation(this.element, e, this.options);
    if (!t) return (this._onFinish(), null);
    ((this.domPlayer = t), (this._finalKeyframe = e.length ? e[e.length - 1] : new Map()));
    let s = () => this._onFinish();
    return (
      t.addEventListener(`finish`, s),
      this.onDestroy(() => {
  ...
  _triggerWebAnimation(e, t, s) {
    let i = this._convertKeyframesToObject(t);
    try {
  ...
  finish() {
    (this.init(),
      this.domPlayer &&
        (this._specialStyles && this._specialStyles.finish(), this._onFinish(), this.domPlayer.finish()));
  }
  reset() {
  ...
  beforeDestroy() {
    ...
    (this.hasStarted() &&
      this._finalKeyframe.forEach((s, i) => {
        i !== `offset` && e.set(i, this._finished ? s : Te(this.element, i));
      }),
...
var ct = class {
  ...
  animate(e, t, s, i, r, a = []) {
    let l = { duration: s, delay: i, fill: i == 0 ? `both` : `forwards` };
    r && (l.easing = r);
    let u = new Map(),
      c = a.filter((y) => y instanceof ke);
    ts(s, i) &&
      c.forEach((y) => {
        y.currentSnapshot.forEach((d, g) => u.set(g, d));
      });
    let h = Zt(t).map((y) => new Map(y));
    h = ss(e, h, u);
    let S = yi(e, h);
    return new ke(e, h, l, S);
  }
};
function Di(n, e) {
  return n === `noop` ? new Me(e, new gs(), new Ze()) : new Me(e, new ct(), new et());
}
var ms = class {
  _driver;
  _animationAst;
  constructor(e, t) {
    ...
    let s = [],
      r = dt(e, t, s, []);
    if (s.length) throw qt(s);
    this._animationAst = r;
  }
  buildTimelines(e, t, s, i, r) {
    let a = Array.isArray(t) ? je(t) : t,
      o = Array.isArray(s) ? je(s) : s,
      l = [];
    r = r || new ne();
    let u = pt(this._driver, e, this._animationAst, _e, ae, a, o, i, r, l);
    if (l.length) throw Bt(l);
    return u;
  }
};
var Ae = `@`;
...
var Fe = class {
  ...
  setProperty(e, t, s) {
    t.charAt(0) == Ae && t == Ts ? this.disableAnimations(e, !!s) : this.delegate.setProperty(e, t, s);
  }
  setValue(e, t) {
  ...
  listen(e, t, s, i) {
    if (t.charAt(0) == Ae) {
      let r = Ei(e),
        ...
        o = ``;
      return (
        a.charAt(0) != Ae && ([a, o] = Ti(a)),
        this.engine.listen(this.namespaceId, r, a, o, (l) => {
          let u = l._data || -1;
...
var ps = class {
  ...
  createRenderer(e, t) {
    ...
    return (t.data.animation.forEach(o), new ft(this, a, i, this.engine));
  }
  begin() {
...
export {
  is as AnimationDriver,
  gs as NoopAnimationDriver,
  ms as ɵAnimation,
  Me as ɵAnimationEngine,
  ft as ɵAnimationRenderer,
  ps as ɵAnimationRendererFactory,
  Je as ɵAnimationStyleNormalizer,
  Fe as ɵBaseAnimationRenderer,
  _e as ɵENTER_CLASSNAME,
  ae as ɵLEAVE_CLASSNAME,
  Ze as ɵNoopAnimationStyleNormalizer,
  fe as ɵTransitionAnimationPlayer,
  ct as ɵWebAnimationsDriver,
  ke as ɵWebAnimationsPlayer,
  et as ɵWebAnimationsStyleNormalizer,
  ts as ɵallowPreviousPlayerStylesMerge,
  qs as ɵcamelCaseToDashCase,
  Qe as ɵcontainsElement,
  Di as ɵcreateEngine,
  ye as ɵgetParentElement,
  Ve as ɵinvokeQuery,
  Zt as ɵnormalizeKeyframes,
  Jt as ɵvalidateStyleProperty,
  Fs as ɵvalidateWebAnimatableStyleProperty,
};
